// Seed data + helpers. Extracted from DataContext.jsx so the ~900-line static
// fixture set doesn't ship in the eager DataContext chunk — it's now
// dynamic-imported only by seedFirestore() when an empty database needs to
...
export function agentFields(job) {
  return {
