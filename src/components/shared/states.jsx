...
// Standardized "Clear all filters" button for an EmptyState's `action` slot.
// Single canonical version used by every queue's no-match empty state.
export function ClearFiltersButton({ onClick, label = 'Clear all filters' }) {
